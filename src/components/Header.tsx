    ...
    <header className="py-2 z-50 px-5 md:px-10 lg:px-14 bg-black bg-opacity-80 shadow-md w-full fixed top-0 left-0 lg:flex lg:justify-between lg:items-center">
      ...
      <nav>
            <ul className={`grid lg:items-center w-full transition-all ease-in duration-500 ${isOpen ? 'hidden' : 'block'} lg:hidden `}>
                ...
                <li className="mx-4 my-2 lg:my-0 text-white"><a href="./pages/checkoutProduct.html">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="size-6">
                ...
                <div className="grid lg:flex gap-5">
                  <button  className="navbar-nav sign-in rounded-lg px-6 py-2 border border-white bg-transparent text-white text-sm">Sign In</button>
                  <button className="navbar-nav sign-up rounded-lg px-6 py-2 bg-primary opacity-100 border-none text-sm">Sign Up</button>
                </div>
            </ul>
