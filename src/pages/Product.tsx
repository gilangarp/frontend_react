import satu from "../assets/image/image 46.png";
import product from "../assets/image/a63f096d3edcb57b0bc937039acae071.png";


export default function Product() {
  return (
    <main className=" min-h-screen">
      <section className="bg-[url('/src/assets/image/Rectangle 299.png')] w-full h-[40vh] bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: `url('/src/assets/image/Rectangle 299.png')` }}>
          ...
          <div
            ...
            <div className="w-[335px] h-fit bg-[#88B788] overflow-hidden rounded-3xl grid grid-cols-[auto,1fr] snap-center grid-rows-1">
              <div className="w-24 h-[80px] pl-[1%] rounded-3xl">
                <img src={satu} alt="" className="object-cover" />
              </div>
        ...
        <div className="grid grid-cols-1 grid-rows-[auto,1fr] lg:grid-cols-[30%,70%] lg:grid-rows-1 gap-5">
          <div className="grid gap-3 lg:hidden">
            <div className="flex justify-between p-1 rounded-lg text-black border border-primary">
              <input
                className="bg-transparent border-none outline-none focus:ring-0 focus:border-transparent"
                type="text"
                name="searchFilter"
            ...
            <div className=" grid grid-cols-[1fr,1fr,auto] gap-2">
              ...
              <div>
                <div className="">
                  ...
                  <div
                    id="categoryDropdown"
                    className="hidden absolute dropdown-menu w-fit p-2 rounded-lg bg-slate-300 text-sm">
                    <option value="">All Products</option>
                    <option value="">Favorite Coffee</option>
                    <option value="">Favorite Non-Coffee</option>
                    <option value="">Favorite Foods</option>
          ...
          <div className="hidden lg:block">
            ...
            <div className="filter-menu basis-1/3 bg-black rounded-lg flex flex-col p-8 gap-4 h-max	">
              ...
              <section className=" category text-white  flex-col gap-4">
          ...
          <div className="slide-content grid justify-items-center items-center grid-cols-[1fr,1fr,1fr,1fr] lg:grid-cols-[1fr,1fr] gap-1 h-fit overflow-x-scroll snap-mandatory snap-x">
